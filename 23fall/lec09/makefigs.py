...
# https://stackoverflow.com/questions/29188612/arrows-in-matplotlib-using-mplot3d/29188796#29188796
# Some code copied from https://github.com/matplotlib/matplotlib/issues/21688
...
#####################################################################
# Plot one step of gradient descent on a complicated error surface
def sigmoid(x):
    return 1/(1+np.exp(-x))
def sigmoid_deriv(x):
