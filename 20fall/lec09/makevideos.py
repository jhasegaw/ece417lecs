...
subprocess.call('convert -delay 25 -dispose previous exp/forward?.png exp/forward??.png  exp/forward.gif'.split())
...
subprocess.call('convert -delay 25 -dispose previous exp/backward?.png exp/backward??.png  exp/backward.gif'.split())
